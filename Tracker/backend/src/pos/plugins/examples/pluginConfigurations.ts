/**
 * Example POS Plugin Configurations
 * These show how POS systems can be configured dynamically without code changes
 */

import { POSPluginConfig } from '../POSPluginManager';

// Shopify Plugin Configuration
export const shopifyPluginConfig: POSPluginConfig = {
  id: 'shopify',
  name: 'Shopify',
...
// Square Plugin Configuration
export const squarePluginConfig: POSPluginConfig = {
  id: 'square',
  name: 'Square',
...
// Clover Plugin Configuration (API Key based)
export const cloverPluginConfig: POSPluginConfig = {
  id: 'clover',
  name: 'Clover',
...
export const toastPluginConfig: POSPluginConfig = {
  id: 'toast',
  name: 'Toast',
...
export const pluginConfigurations = {
  shopify: shopifyPluginConfig,
  square: squarePluginConfig,
  clover: cloverPluginConfig,
  toast: toastPluginConfig
};
