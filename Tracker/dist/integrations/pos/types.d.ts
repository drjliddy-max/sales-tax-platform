...
export interface POSAdapter {
    ...
    syncInventory?(credentials: AuthCredentials, locationId: string): Promise<any[]>;
}
...
export declare class POSIntegrationError extends Error implements POSIntegrationError {
    code: string;
    posType: POSSystemType;
    statusCode?: number | undefined;
    retryable: boolean;
    details?: Record<string, any> | undefined;
    constructor(message: string, code: string, posType: POSSystemType, statusCode?: number | undefined, retryable?: boolean, details?: Record<string, any> | undefined);
}
